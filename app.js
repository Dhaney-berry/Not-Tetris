document.addEventListener("DOMContentLoaded", () => {
    ...
    const tetrominos = [l_Tetromino, z_Tetromino, t_Tetromino, block_Tetromino, bar_Tetromino]

    let currentPosition = 4
    let currentRotation = 0

    console.log(tetrominos[0][0])

    // Ramdomly select a tetromino in its first rotation
    ...
    // Move the tetromino left, unless is at edge or has blockage
    function moveLeft() {
        erase()
